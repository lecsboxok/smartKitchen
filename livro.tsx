...
export default function Livro() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira um livro seguindo os seguintes critérios: ${ingr1}, ${ingr2} e ${ingr4} e pesquise o livro no YouTube. Caso encontre, informe o link.`;
  ...
  return (
    <View style={ESTILOS.container}>
      ...
      <View style={ESTILOS.form}>
        ...
        <TextInput
          placeholder="Ficção ou não-ficção"
          style={ESTILOS.input}
          value={ingr1}
